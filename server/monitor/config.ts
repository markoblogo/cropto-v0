...
export const MONITOR_FEATURE_FLAGS: MonitorFeatureFlags = {
  ...
  ENABLE_GRAIN_MARKETS_CORE: flag("ENABLE_GRAIN_MARKETS_CORE", true),
  ENABLE_GRAIN_WIDGETS_EXPANSION: flag("ENABLE_GRAIN_WIDGETS_EXPANSION", true),
};
...
export const MONITOR_SOURCES: MonitorSource[] = [
  ...
  {
    id: "brownfield-markets",
    name: "Brownfield Markets",
    url: "https://brownfieldagnews.com/category/markets/feed/",
    category: "agro-general",
    strategy: "rss",
    enabled: true,
  },
  {
    id: "brownfield-weather",
    name: "Brownfield Weather",
    url: "https://brownfieldagnews.com/category/weather/feed/",
    category: "agro-general",
    strategy: "rss",
    enabled: true,
  },
  ...
  {
    id: "agri-pulse-free",
    name: "Agri-Pulse (Free)",
    url: "https://www.agri-pulse.com/rss/topic/34-rss",
...
export const MONITOR_SOURCE_NOISE_PATTERNS: Record<string, string[]> = {
  ...
  "hellenic-shipping-news": ["opinion", "advertisement"],
