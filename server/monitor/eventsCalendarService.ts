...
const EVENTS_CATALOG: EventsCatalog = {
  events: [
    ...
    {
      id: "ograin_winter_conference_2026",
      title: "OGRAIN Winter Conference 2026",
      scope: "national",
      segment: ["organic_grains", "wheat", "corn", "soybeans", "research"],
      region: "North America",
      country: "US",
      city: "Madison",
      start_date: "2026-01-22",
      end_date: "2026-01-24",
      website: "https://ograin.cals.wisc.edu/ograin-events/conference/",
    },
    {
      id: "agro_annual_conference_2026",
      title: "AGRO Annual Conference 2026",
      scope: "national",
      segment: ["regulation", "grain_quality", "inspection", "policy"],
      region: "North America",
      country: "US",
      city: "Grand Rapids",
      start_date: "2026-10-05",
      end_date: "2026-10-08",
      website: "https://www.agro-online.org/events",
    },
    ...
    {
      id: "cwa_grain_expo_2026",
      title: "CWA Grain Expo 2026",
      scope: "national",
      segment: ["grain_trading", "producers", "western_canada", "markets"],
      region: "North America",
      country: "CA",
      city: "Regina",
      start_date: "2026-11-24",
      end_date: "2026-11-25",
      website: "https://agribition.com/events/conferences/grain-expo/",
    },
    {
      id: "pgdc_annual_meeting_2026",
      title: "PGDC Annual Meeting 2026",
      scope: "national",
      segment: ["research", "varieties", "wheat", "barley", "oats"],
      region: "North America",
      country: "CA",
      city: "Banff",
      start_date: "2026-03-02",
      end_date: "2026-03-05",
      website: "https://www.pgdc.ca/meeting_pd.html",
    },
    ...
    {
      id: "agro_kiev_2026",
      title: "AGRO KIEV 2026",
      scope: "national",
      segment: ["exhibition", "agriculture", "machinery", "agrochemicals", "ukraine"],
      region: "Black Sea",
      country: "UA",
      city: "Kyiv",
      start_date: "2026-06-10",
      end_date: "2026-06-13",
      website: "https://www.agro-expo.com.ua",
    },
    {
      id: "ukraine_export_logistics_2026",
      title: "Ukraine Export Logistics 2026",
      scope: "national",
      segment: ["logistics", "export", "ports", "rail", "danube", "black_sea", "ukraine"],
      region: "Black Sea",
      country: "UA",
      city: "Kyiv",
      start_date: "2026-10-01",
      end_date: "2026-10-01",
      website: "https://ukragroconsult.com/",
    },
    ...
    {
      id: "agroactiva_2026",
      title: "Agroactiva 2026",
      scope: "national",
      segment: ["exhibition", "machinery", "wheat", "corn", "soybeans", "argentina_ag"],
      region: "South America",
      country: "AR",
      city: "Armstrong",
      start_date: "2026-06-03",
      end_date: "2026-06-06",
      website: "https://agroactiva.com/",
    },
    ...
    {
      id: "datagro_corn_ethanol_2026",
      title: "DATAGRO International Conference on Corn Ethanol 2026",
      scope: "national",
      segment: ["corn", "ethanol", "biofuels", "logistics", "brazil_corn"],
      region: "South America",
      country: "BR",
      city: "Sao Paulo",
      start_date: "2026-05-20",
      end_date: "2026-05-21",
      website: "https://www.datagroconferences.com/en/eventos/international-conference-datagro-about-corn-ethanol-2026/",
    },
    {
      id: "cbda_2026",
      title: "CBDA 2026 - Congresso Brasileiro de Direito do Agronegocio",
      scope: "national",
      segment: ["ag_law", "regulation", "finance", "risk", "agribusiness"],
      region: "South America",
      country: "BR",
      city: "Sao Paulo",
      start_date: "2026-08-20",
      end_date: "2026-08-21",
      website: "https://congressodireitoagro.com.br/",
    },

    {
      id: "ece_rotterdam_2026",
      title: "European Commodities Exchange 2026",
      scope: "global",
      segment: ["commodities", "grain_trading", "feed", "milling", "logistics"],
      region: "Europe",
      country: "NL",
      city: "Rotterdam",
      start_date: "2026-11-05",
      end_date: "2026-11-06",
      website: "https://www.ece-rotterdam2026.eu/",
    },
    {
      id: "granular_rustik_final_2026",
      title: "GRANULAR & RUSTIK Final Conference 2026",
      scope: "global",
      segment: ["rural_development", "data", "policy", "sustainability"],
      region: "Europe",
      country: "BE",
      city: "Brussels",
      start_date: "2026-06-24",
      end_date: "2026-06-24",
      website: "https://euagenda.eu/events/2026/06/24/granular-and-rustik-final-conference-2026",
    },
    {
      id: "european_flour_millers_congress_2026",
      title: "European Flour Millers Congress 2026",
      scope: "global",
      segment: ["wheat", "milling", "flour", "grain_quality", "policy"],
      region: "Europe",
      country: "DE",
      city: "Berlin",
      start_date: "2026-09-16",
      end_date: "2026-09-17",
      website: "https://www.flourmillers.eu/page/congress-2026/",
    },
    {
      id: "space_rennes_2026",
      title: "SPACE 2026",
      scope: "global",
      segment: ["feed", "livestock", "cereals", "exhibition", "technology"],
      region: "Europe",
      country: "FR",
      city: "Rennes",
      start_date: "2026-09-15",
      end_date: "2026-09-17",
      website: "https://www.space.fr/en/",
    },
    {
      id: "paris_agriculture_week_2026",
      title: "Paris Agriculture Week 2026",
      scope: "global",
      segment: ["global_ag", "policy", "innovation", "networking"],
      region: "Europe",
      country: "FR",
      city: "Paris",
      start_date: "2026-02-21",
      end_date: "2026-03-01",
      website: "https://www.sia-pro.com/en/event/paris-agriculture-week",
    },
    {
      id: "wheat_congress_bologna_2026",
      title: "International Wheat Congress 2026",
      scope: "global",
      segment: ["wheat", "research", "breeding", "climate", "policy"],
      region: "Europe",
      country: "IT",
      city: "Bologna",
