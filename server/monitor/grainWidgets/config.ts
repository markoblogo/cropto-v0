...
export const OECD_AGRICULTURAL_OUTLOOK_OILSEEDS_URL =
  ...
  "https://www.oecd.org/en/publications/oecd-fao-agricultural-outlook-2025-2034_601276cd-en.html";
export const OECD_AGRICULTURAL_OUTLOOK_SDMX_BASE_URL = normalizeBaseUrl(
  process.env.OECD_AGRICULTURAL_OUTLOOK_SDMX_BASE_URL || "",
  "https://sdmx.oecd.org/public/rest/data",
);
export const OECD_AGRICULTURAL_OUTLOOK_SDMX_DATASET =
  process.env.OECD_AGRICULTURAL_OUTLOOK_SDMX_DATASET ||
  "OECD.TAD.ATM,DSD_AGR@DF_OUTLOOK_2025_2034,1.1";
export const OECD_AGRICULTURAL_OUTLOOK_SDMX_START_PERIOD =
  process.env.OECD_AGRICULTURAL_OUTLOOK_SDMX_START_PERIOD ||
  "2020";
