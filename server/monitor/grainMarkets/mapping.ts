...
export function quoteToWidget(quote: GrainMarketQuoteNormalized): GrainMarketWidgetItem {
  return {
    ...
    unit: quote.unit,
    nativeValueCurrent: quote.nativeValueCurrent,
    nativeValueChange: quote.nativeValueChange,
    nativeValueChangePct: quote.nativeValueChangePct,
    nativeCurrency: quote.nativeCurrency,
    nativeUnit: quote.nativeUnit,
    normalizedValueCurrent: quote.normalizedValueCurrent,
    normalizedValueChange: quote.normalizedValueChange,
    normalizedValueChangePct: quote.normalizedValueChangePct,
    normalizedCurrency: quote.normalizedCurrency,
    normalizedUnit: quote.normalizedUnit,
    normalizationStatus: quote.normalizationStatus,
    normalizationMethod: quote.normalizationMethod,
    normalizationMeta: quote.normalizationMeta,
    series: quote.series,
    notes: quote.notes,
