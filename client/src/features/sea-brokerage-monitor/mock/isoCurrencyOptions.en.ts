...
// ISO 4217 currencies (runtime-derived from Intl.supportedValuesOf at generation time).
export const isoCurrencyOptionsEn: SelectOption<Currency>[] = [
  ...
  { value: "SLL", label: "SLL - Sierra Leonean Leone (1964—2022)" },
  ...
  { value: "ZWG", label: "ZWG - Zimbabwean Gold" },
  { value: "ZWL", label: "ZWL - Zimbabwean Dollar (2009–2024)" },
];
