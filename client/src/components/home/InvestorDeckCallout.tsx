...
export function InvestorDeckCallout() {
  ...
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-xl border border-border/85 bg-gradient-to-br from-card via-card to-muted/35 p-3 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 md:p-3.5"
    >
      ...
      <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-20 overflow-hidden sm:block">
        <img src={previewImage} alt="" aria-hidden="true" className="h-full w-full object-cover opacity-55" />
        <div className="absolute inset-0 bg-gradient-to-l from-black/35 via-black/15 to-transparent dark:from-black/55 dark:via-black/20 dark:to-transparent" />
      </div>
      ...
      <div className="relative flex items-start justify-between gap-3 pr-0 sm:pr-20">
        <div className="space-y-1.5">
          <div className="flex items-center gap-1.5">
            ...
            <Badge variant="outline" className="hidden text-[10px] uppercase tracking-wide lg:inline-flex">
              Slides + PDF
            </Badge>
          </div>
          <p className="text-sm font-semibold leading-tight md:text-base">Cropto Deck</p>
        ...
        <div className="rounded-md border border-border/70 bg-muted/45 p-1.5 text-muted-foreground transition-colors group-hover:border-primary/30 group-hover:text-primary">
