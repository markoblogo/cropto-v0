...
const STATIC_VIDEO_SOURCES: VideoSource[] = [
  ...
  },
  {
    ...
    status: "LIVE_EMBED",
    mode: "iframe",
    url: "https://camstreamer.com/embed/stream/44240",
    note: "Live harbor cam (CamStreamer embed)",
  },
  {
    ...
    status: "LIVE_EMBED",
    mode: "iframe",
    url: "https://camstreamer.com/embed/stream/22393",
    note: "Live port cam Villefranche-sur-Mer",
  },
  {
