  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section id="problem" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-10 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              {PROBLEM_BULLETS.map((item, index) => (
                <Card key={item} className={index === 0 ? "border-primary/35 bg-primary/5" : ""}>
        ...
        <section id="product" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-10 px-4 sm:px-6 lg:px-8">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2.5 text-sm leading-7 text-foreground/80">
            ...
            <Card className="border-border/80 bg-muted/35">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-8 text-foreground/80">{DECK_PAGE_COPY.statusBody}</p>
        ...
        <section id="market-model" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-10 px-4 sm:px-6 lg:px-8">
            ...
            <Card className="border-primary/30 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent shadow-md">
        ...
        <section id="deck" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-7 px-4 sm:px-6 lg:px-8">
            ...
            <div className="overflow-hidden rounded-2xl border border-border/90 bg-gradient-to-b from-muted/65 via-card to-card p-3 shadow-[0_14px_36px_rgba(0,0,0,0.22)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.45)] sm:p-4">
        ...
        <section id="faq" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">{DECK_PAGE_COPY.faqTitle}</h2>
            <Card>
              <CardContent className="p-3 sm:p-5">
                <Accordion type="single" collapsible className="w-full">
                  {DECK_FAQ_ITEMS.map((item, index) => (
                    <AccordionItem key={item.question} value={`faq-${index}`}>
                      <AccordionTrigger className="text-left text-sm leading-7 sm:text-base">{item.question}</AccordionTrigger>
        ...
        <section id="contact" className="scroll-mt-24 border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto space-y-7 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl space-y-4">
              ...
              <div className="space-y-1 text-sm leading-7 text-foreground/80">
