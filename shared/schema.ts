...
export const seaBrokerageEntries = pgTable("sea_brokerage_entries", {
  ...
  tradeSellerBrokerTelegramUserId: text("trade_seller_broker_telegram_user_id"),
  tradeSellerBrokerTelegramUsername: text("trade_seller_broker_telegram_username"),
  tradeBuyerBrokerTelegramUserId: text("trade_buyer_broker_telegram_user_id"),
  tradeBuyerBrokerTelegramUsername: text("trade_buyer_broker_telegram_username"),
  ...
  isNewCrop: boolean("is_new_crop").notNull().default(false),
