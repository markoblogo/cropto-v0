...
3. В системе есть товар WHEAT с установленной ценой

## Шаги тестирования

### 1. Проверка текущей цены WHEAT
- Откройте Dashboard или Index Management
- Найдите текущую цену WHEAT (например, $240/ton)
...
### 4. Обновление цены WHEAT
- Перейдите в Index Management (нужны права broker)
- Обновите цену WHEAT до `CURRENT_PRICE * 1.3` (например, $240 → $312/ton)
